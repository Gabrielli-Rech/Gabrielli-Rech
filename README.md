...
Sou uma desenvolvedora versátil com forte paixão pelo ecossistema **Web Full-Stack** e por **UI/UX Design**. Adoro estar envolvida em toda a jornada do produto: desde a prototipagem de uma interface amigável até a construção de uma arquitetura robusta no back-end.

Embora meu foco principal seja criar aplicações web incríveis, minha base técnica vai além: construo sistemas desktop, exploro integrações com IoT e estou sempre testando novas linguagens. Entre commits, deploys e a busca pela próxima platina na Steam, meu objetivo é simples: evoluir continuamente e entregar soluções de alto impacto.
...
<details>
  <summary><strong>Ver habilidades detalhadas por categoria</strong></summary>
  <br>
  
  **🌐 Desenvolvimento Web (Front-End & Back-End):** <br><br>
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="https://github.com/Gabrielli-Rech/Titan-Fit" target="_blank">
        <img src="https://github.com/user-attachments/assets/fb12e53d-0a2a-48af-9322-3d9db9a25378" alt="Preview do Projeto Titan Fit" width="100%" style="border-radius: 10px; border: 1px solid #e1e4e8;" />
      </a>
    </td>
    <td width="50%" valign="top" style="padding-left: 20px;">
      <h3>🏋️‍♀️ Titan Fit — Gestão de Academias</h3>
      <p>
        Sistema web Full-Stack desenvolvido com <strong>PHP e MySQL</strong>. Criado para modernizar a administração de academias, unindo regras de negócio complexas com uma interface amigável.
      </p>
      <ul>
        <li>Gerenciamento completo de alunos, planos e treinos</li>
        <li>Design responsivo com foco em usabilidade</li>
        <li>Geração de relatórios automatizados</li>
      </ul>
      <a href="https://github.com/Gabrielli-Rech/Titan-Fit" target="_blank"><strong>🔗 Ver repositório no GitHub</strong></a>
    </td>
  </tr>
</table>

### 💼 Portfólio de Soluções
* **Agendwork:** Plataforma SaaS (Web) e painel de controle C-level. Focado na experiência do usuário e prototipagem avançada no Figma, além de explorar o uso de Three.js para landing pages 3D imersivas.
* **Gerenciador de Almoxarifado:** Aplicação Desktop robusta desenvolvida em **Java**, implementando arquitetura MVC para um controle rígido e seguro de estoque.
